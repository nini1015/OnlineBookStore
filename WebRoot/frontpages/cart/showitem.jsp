...
<html>
  <head>
	...
	-->
	<link rel="stylesheet" type="text/css" href="<c:url value='/frontpages/css/cart/showitem.css'/>">
...
<script type="text/javascript">
  ...
  <body>
  <c:choose>
  	<c:when test="${empty cartItemList }">没有订单哦~~</c:when>
  	<c:otherwise>
...
<c:forEach items="${cartItemList }" var="cartItem">
	...
	<tr>
		<td colspan="6">
			<input id="addr" type="text" name="address" value="广东省 广州市 海珠区 "/>
		</td>
	</tr>
	<tr>
